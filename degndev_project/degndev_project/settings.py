"""
Django settings for degndev_project project.
...
SECRET_KEY = 'p4j6gqggls=rube@nt#kl0oua2)bx!a32oa!yx0s#u+t4i94^3'
...
ROOT_URLCONF = 'degndev_project.urls'
...
WSGI_APPLICATION = 'degndev_project.wsgi.application'
